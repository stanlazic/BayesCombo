...
#'
#' @details This function plots the data from the \code{pmp.combo()}
#' function. The results may be hard to visualise if the effect sizes are very
#' different, and it may be preferable to standardise the effect sizes
#' by setting \code{scale = TRUE} in the \code{pmp.combo()} function.
#'
